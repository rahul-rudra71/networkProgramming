...
public class Peer2 {
    ...
    private static class peerHandler extends Thread {
                ...
                while(true) {
                    ...
                    if(shake) {
                        ...
                        if((inMessage.substring(0, 18)).equals("P2PFILESHARINGPROJ")) {
                            ...
                            shake = true;
                        //otherwise bad handshake and retry connection
                        }
                         else {
                            ...
                            /*The client will keep trying to reconnect with the server after a timed 
                            delay of 5 seconds. If the handshake is successful, the connection is 
                            established and the message is printed to the console. If the connection is 
                            unable to establish, it disconnects*/

                            if(retryConnection(false)){
                                System.out.println("Handshake successful. Connection is established.");
                            }
                            else{
                                System.out.println("Connection refused. The server timed out.");
                            } 
       ...
       //method to retry connection
        ...
        public boolean retryConnection(boolean shake) {
            if(!shake)
            
               for(int i=0; i <= 10; i++) {
                //calls timedDelay method to pause for 5 seconds
                timedDelay(5);
                 ...
                 System.err.println("Connection refused. Attempting to reconnect in 5 seconds.");             
